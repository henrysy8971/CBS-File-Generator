...
CREATE TABLE FILE_GENERATION (
    FILE_GEN_ID NUMBER GENERATED ALWAYS AS IDENTITY,
    JOB_ID VARCHAR2(100) NOT NULL,
    INTERFACE_TYPE VARCHAR2(100),
    FILE_NAME VARCHAR2(255) NOT NULL,
    FILE_PATH VARCHAR2(500) NOT NULL,
    STATUS VARCHAR2(20) CHECK (STATUS IN ('PENDING','PROCESSING','STOPPED','FINALIZING','COMPLETED','FAILED')),
    RECORD_COUNT NUMBER,
...
CREATE INDEX IDX_FILE_GEN_INTERFACE_TYPE ON FILE_GENERATION(INTERFACE_TYPE);
